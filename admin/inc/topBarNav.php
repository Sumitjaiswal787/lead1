<!-- Custom CSS in dist/css/custom.css -->

<!-- Navbar -->
<nav
  class="main-header navbar navbar-expand navbar-light border-top-0  border-left-0 border-right-0 text-sm shadow-sm bg-gradient-light">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?php echo base_url ?>"
        class="nav-link"><b><?php echo (!isMobileDevice()) ? $_settings->info('name') : $_settings->info('short_name'); ?></b></a>
    </li>
  </ul>
  <!-- Right navbar links -->
      ...
      <div class="btn-group nav-link">
        <button type="button" class="btn btn-rounded badge badge-light dropdown-toggle dropdown-icon"
          ...
          <span><img src="<?php echo validate_image($_settings->userdata('avatar')) ?>"
              class="img-circle elevation-2 user-img-nav" alt="User Image"></span>
          <span
