...
<body class="layout-fixed control-sidebar-slide-open layout-navbar-fixed" data-new-gr-c-s-check-loaded="14.991.0"
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper pt-3" style="min-height: 567.854px;">
      ...
      <!-- /.content -->
      <div class="modal fade glass-modal" id="confirm_modal" role='dialog'>
      ...
      <div class="modal fade rounded-0 glass-modal" id="uni_modal" role='dialog'>
        <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal fade rounded-0 glass-modal" id="uni_modal_right" role='dialog'>
