...
<head>
    ...
    <style>
        ...
        .card { border-radius: 16px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); }
        .btn { border-radius: 12px; }
        .phone-number a { text-decoration: none; color: #007bff; font-weight: bold; }
    </style>
</head>
<body>
    ...
    <div class="card p-4">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover align-middle bg-white">
                ...
                <?php
                if ($isSuperAdmin) {
                    $query = "SELECT r.id, r.call_date, r.notes, r.status, 
