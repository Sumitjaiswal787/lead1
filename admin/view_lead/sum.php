...
// Security check: Only allow 'admin' type users (type = 1)
...
// Fetch staff under this admin only
$users_query = $conn->query("SELECT id, firstname, lastname FROM users WHERE type != 1 AND admin_id = $admin_id ORDER BY firstname ASC");
$users = [];
...
$status_map = [
    'fresh' => ['label' => 'Fresh Inquiry', 'color' => '#17a2b8', 'icon' => 'fas fa-seedling', 'status_code' => 5],
    'interested' => ['label' => 'Interested', 'color' => '#28a745', 'icon' => 'fas fa-handshake', 'status_code' => 1],
    'site_visit' => ['label' => 'Site Visit', 'color' => '#663399', 'icon' => 'fas fa-map-marker-alt', 'status_code' => 7],
    'callback' => ['label' => 'Callback Scheduled', 'color' => '#ffc107', 'icon' => 'fas fa-phone', 'status_code' => 2],
    'not_interested' => ['label' => 'Not Interested', 'color' => '#dc3545', 'icon' => 'fas fa-thumbs-down', 'status_code' => 0],
    'no_answer' => ['label' => 'No Answer', 'color' => '#343a40', 'icon' => 'fas fa-phone-slash', 'status_code' => 3],
    'invalid' => ['label' => 'Invalid Contact', 'color' => '#6f42c1', 'icon' => 'fas fa-times-circle', 'status_code' => 4],
    'investment_done' => ['label' => 'Investment Done', 'color' => '#20c997', 'icon' => 'fas fa-chart-line', 'status_code' => 6],
    'Switched Off' => ['label' => 'Switched Off', 'color' => '#dc3545', 'icon' => 'fas fa-thumbs-down', 'status_code' => 8]
];

$status_map_for_cards = ['assigned' => ['label' => 'Total Assigned', 'color' => '#6c757d', 'icon' => 'fas fa-tasks', 'status_code' => null]] + $status_map;
?>
