	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
                ...
                <?php
                // Auto-assign admin_id if creating staff
                if ($_settings->userdata('type') == 1 && (!isset($meta['type']) || $meta['type'] == 2)) {
                    echo '<input type="hidden" name="admin_id" value="'.$_settings->userdata('id').'">';
                }
                ?>
